...
function search(e){
  ...
  return (
    <div className='container d-flex justify-content-between' >
      ...
      <div className="avatar text-center"  style={{backgroundColor:"black",color:"white",width:"18%",border:"0.2rem solid black",borderRadius:"0.15rem",margin:"5%",alignSelf:"center",justifySelf:"center",fontWeight:"bold"}}>
      <CgProfile/><a href="/" onClick={con.logout}>{props.name}</a>
      </div>
      <div className="searchbar my-3 mx-3" style={{height:"7vh",width:"40vw",postion:"sticky"}}>
